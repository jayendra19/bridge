...
import collectFee from '../tokens/layer2';
...
async function validateForm(
  ...
  try {
    ...
    const dataMoni =await collectFee(values);
    if (!dataMoni) return { token: 'transactionfee is required' };
